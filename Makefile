...
html_window.o : html_window.cpp $(INCS)
	g++ -c $(DBUG) -fno-pie -no-pie -DCEF_USE_SANDBOX -D__STDC_CONSTANT_MACROS -D__STDC_FORMAT_MACROS -Wno-unused-parameter -Wno-write-strings -Wno-class-memaccess -I$(CEF_PATH) -I$(CEF_PATH)/include html_window.cpp
...
osg.o: osg.cpp
	g++ -Wno-deprecated-declarations $(CFLAGS) osg.cpp
...
cowcam: cowcam.o test_serial_ports.o embed_app.o osg.o networking.o pulse_devices.o PulseAudio.o muxer.o vlc_window.o extract_video.o extract_audio.o cow_simple_pulse.o html_window.o
	$(LD) -o cowcam $(LDFLAGS) cowcam.o test_serial_ports.o embed_app.o osg.o networking.o pulse_devices.o PulseAudio.o muxer.o vlc_window.o extract_video.o extract_audio.o cow_simple_pulse.o html_window.o -Xlinker -Bdynamic $(STDDYN) ./libcef.so $(CEF_PATH)/build/libcef_dll_wrapper/libcef_dll_wrapper.a
